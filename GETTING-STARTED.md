...
| **Advanced** | Power users | All 76 skills + Dream Mode, background automation, self-improving skills |
...
You have access to **76 pre-built skills** organized into 8 categories. You don't need to memorize them — just describe what you need and the AI will route to the right skill automatically.
