...
echo "----------------------------------------"
echo "Next Steps:"
echo "1. Open your primary Agent session (Cursor, Claude Code, or Gemini)."
echo "2. Copy the contents of ONBOARDING_PROMPT.md and paste it into the chat."
echo "3. The AI will launch an interactive setup wizard to configure your system."
echo ""
