...
3. **Eval criteria** — What 3-6 binary yes/no checks define a good output? (these are your "test questions" — see [../../guides/prompt-eval-guide.md](../../guides/prompt-eval-guide.md) for how to write good evals)
...
See [../../guides/prompt-eval-guide.md](../../guides/prompt-eval-guide.md) for detailed examples of good vs bad evals.
